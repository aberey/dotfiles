...
plugins=(aws brew cp docker docker-compose docker-machine git github golang kubectl man mvn node osx python sbt scala sudo terraform tmux ubuntu vagrant)
